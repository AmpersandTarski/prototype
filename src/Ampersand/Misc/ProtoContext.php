...
abstract class ProtoContext
{
    ...
    const
        REL_IFC_ROLES               = 'pf_ifcRoles[PF_Interface*PF_Role]',
        ...
        REL_ROLE_LABEL              = 'label[PF_Role*PF_Label]',
        REL_SESSION_ALLOWED_ROLES   = 'sessionAllowedRoles[SESSION*PF_Role]',
        REL_SESSION_ACTIVE_ROLES    = 'sessionActiveRoles[SESSION*PF_Role]',
